...
![DIN-Figure5](/assets/img/deep-interest-network/DIN-figure5.png){: w="90%"}
...
$$ \underbrace{[0, 0, 0, 0, 1, 0, 0] }_{\text{weekday=Friday}} \underbrace{[0, 1]}_{\text{gender=Female}} \;\underbrace{[0, .., 1, ..., 1, ...0]}_{\text{visited\_cate\_ids=\{Bag, Book\}}} \; \underbrace{[0, .., 1, ..., 0]}_{\text{ad\_cate\_id=Book}}$$

<br/>

### 3.2 Base model (Embedding & MLP)

![Figure2-basemodel](/assets/img/deep-interest-network/din-figure2-basemodel.png){: w="90%"}
...
![Figure2-DIN](/assets/img/deep-interest-network/din-figure2-din.png){: w="90%"}
...
![DIN-regularization](/assets/img/deep-interest-network/din-regularization.png){: w="90%"}
...
$$ \tag{9} p(x) = \frac{1}{1 + e^{-\frac{s-\mathbb{E}[x]}{Var[x] + \epsilon}}} $$
